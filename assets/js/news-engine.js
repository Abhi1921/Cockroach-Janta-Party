  ...
  const defaultTrendingNews = [
    {
      ...
      image: "assets/img/cjp/trending-cjp-poster-1.png",
      badge: "🚨 LIVE COVERAGE",
    ...
    },
    {
      ...
      image: "assets/img/cjp/trending-cjp-poster-2.png",
      badge: "🎓 EXAM REFORM",
      badgeColor: "var(--gold)",
    ...
    },
    {
      ...
      image: "assets/img/cjp/trending-cjp-poster-3.png",
      badge: "⚡ GOVT TALKS",
      badgeColor: "var(--navy)",
    ...
    },
    {
      ...
      image: "assets/img/cjp/protest-crowd.png",
      badge: "🌐 GLOBAL MEDIA",
      badgeColor: "var(--signal)",
    ...
    },
    {
      ...
      image: "assets/img/cjp/hunger-strike.png",
      badge: "🔥 HUNGER STRIKE",
      badgeColor: "var(--signal)",
    ...
    },
    {
      ...
      image: "assets/img/cjp/student-banners.png",
    ...
    try {
      ...
      if (data && data.status === "ok" && Array.isArray(data.items) && data.items.length > 0) {
        const fetchedGoogleItems = data.items.slice(0, 6).map((item, idx) => ({
          ...
          image: idx % 2 === 0 ? "assets/img/cjp/trending-cjp-poster-2.png" : "assets/img/cjp/student-banners.png",
          badge: "🌐 GOOGLE LIVE",
          badgeColor: "#2563eb",
